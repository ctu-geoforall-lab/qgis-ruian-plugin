...
<qgis version="2.18.0" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="existujedigitalnimapa">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="existujedigitalnimapa" index="5" name=""/>
    <alias field="obeckod" index="6" name=""/>
    <alias field="platiod" index="7" name=""/>
    <alias field="platido" index="8" name=""/>
    <alias field="idtransakce" index="9" name=""/>
    <alias field="globalniidnavrhuzmeny" index="10" name=""/>
    <alias field="rizeniid" index="11" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="62483320">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="existujedigitalnimapa"/>
